...
DEBS_REST=cephadm_${PKGVER}_${ARCH}.deb \
ceph-base_${PKGVER}_${ARCH}.deb \
ceph-common_${PKGVER}_${ARCH}.deb \
ceph-fuse_${PKGVER}_${ARCH}.deb \
ceph-grafana-dashboards_${PKGVER}_all.deb \
ceph-immutable-object-cache_${PKGVER}_${ARCH}.deb \
ceph-mds_${PKGVER}_${ARCH}.deb \
ceph-mgr_${PKGVER}_${ARCH}.deb \
ceph-mgr-cephadm_${PKGVER}_all.deb \
ceph-mgr-dashboard_${PKGVER}_all.deb \
ceph-mgr-diskprediction-cloud_${PKGVER}_all.deb \
ceph-mgr-diskprediction-local_${PKGVER}_all.deb \
ceph-mgr-k8sevents_${PKGVER}_all.deb \
ceph-mgr-modules-core_${PKGVER}_all.deb \
ceph-mgr-rook_${PKGVER}_all.deb \
ceph-mon_${PKGVER}_${ARCH}.deb \
ceph-osd_${PKGVER}_${ARCH}.deb \
ceph-prometheus-alerts_${PKGVER}_all.deb \
ceph-resource-agents_${PKGVER}_${ARCH}.deb \
ceph-test_${PKGVER}_${ARCH}.deb \
cephfs-shell_${PKGVER}_all.deb \
...
libradospp-dev_${PKGVER}_${ARCH}.deb \
...
python3-ceph-common_${PKGVER}_all.deb \
